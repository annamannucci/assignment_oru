...
public class JTSDrawingPanelTaskVisualization implements TaskFleetVisualization {

	private JTSDrawingPanel panel = null;

	public JTSDrawingPanelTaskVisualization() {
		this(null);
	}
	
	public JTSDrawingPanelTaskVisualization(String mapYAMLFile) {
